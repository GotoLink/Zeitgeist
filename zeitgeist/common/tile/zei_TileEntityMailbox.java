...
public class zei_TileEntityMailbox extends TileEntity implements IInventory {
	private ItemStack chestContents[];
	/** Determines if the check for adjacent chests has taken place. */
	public boolean adjacentChestChecked;
	/** Contains the chest tile located adjacent to this one (if any) */
	public zei_TileEntityMailbox adjacentChestZNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public zei_TileEntityMailbox adjacentChestXPos;
	/** Contains the chest tile located adjacent to this one (if any) */
	public zei_TileEntityMailbox adjacentChestXNeg;
	/** Contains the chest tile located adjacent to this one (if any) */
	public zei_TileEntityMailbox adjacentChestZPosition;
	...
	public void checkForAdjacentChests() {
		...
		if (worldObj.getBlockId(xCoord - 1, yCoord, zCoord) == Block.chest.blockID) {
			adjacentChestXNeg = (zei_TileEntityMailbox) worldObj
					.getBlockTileEntity(xCoord - 1, yCoord, zCoord);
		}
		if (worldObj.getBlockId(xCoord + 1, yCoord, zCoord) == Block.chest.blockID) {
			adjacentChestXPos = (zei_TileEntityMailbox) worldObj
					.getBlockTileEntity(xCoord + 1, yCoord, zCoord);
		}
		if (worldObj.getBlockId(xCoord, yCoord, zCoord - 1) == Block.chest.blockID) {
			adjacentChestZNeg = (zei_TileEntityMailbox) worldObj
					.getBlockTileEntity(xCoord, yCoord, zCoord - 1);
		}
		if (worldObj.getBlockId(xCoord, yCoord, zCoord + 1) == Block.chest.blockID) {
			adjacentChestZPosition = (zei_TileEntityMailbox) worldObj
					.getBlockTileEntity(xCoord, yCoord, zCoord + 1);
		}
