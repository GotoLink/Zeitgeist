...
public class zei_EntityAIArrowAttack extends EntityAIBase {
	World worldObj;
	...
	public zei_EntityAIArrowAttack(EntityLiving par1EntityLiving, float par2,
			int par3, int par4) {
	...
	private void doRangedAttack() {
		if (this.rangedAttackID == 1) {
			zei_EntityLaser var1 = new zei_EntityLaser(this.worldObj,
					this.entityHost, this.attackTarget, 1.6F, 12.0F);
