...
public class zei_TileEntityTurnRenderer extends TileEntitySpecialRenderer {
	static float ss = 6f / 256f;
	static float ee = 10f / 256f;

	public void renderTurnAt(zei_TileEntityTurn enti, double x, double y,
			double z, float par8) {
		int i;
	...
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2,
		...
		renderTurnAt((zei_TileEntityTurn) par1TileEntity, par2, par4, par6,
				par8);
	}
}
