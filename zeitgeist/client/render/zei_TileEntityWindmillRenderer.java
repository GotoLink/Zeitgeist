...
public class zei_TileEntityWindmillRenderer extends TileEntitySpecialRenderer {
	public static final ResourceLocation WINDMILL = new ResourceLocation("zeitgeist", "windmill.png");

	@Override
	public void renderTileEntityAt(TileEntity par1TileEntity, double par2, double par4, double par6, float par8) {
		renderTurnAt((zei_TileEntityWindmill) par1TileEntity, par2, par4, par6, par8);
	}

	public void renderTurnAt(zei_TileEntityWindmill enti, double x, double y, double z, float par8) {
		int i;
		 ...
		 * GL11.glTexCoord2f(1, 1); GL11.glVertex3f(1, 0, 0); GL11.glEnd();
		 */
		GL11.glTranslatef(0.5F, 0.5F, 0.5F);
		bindTexture(WINDMILL);
		int j = 45;
		int u = 45;
		int du = i;
		if (i < 2) {
