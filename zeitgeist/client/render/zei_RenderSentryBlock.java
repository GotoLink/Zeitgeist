...
public class zei_RenderSentryBlock {
	...
	public static boolean render(RenderBlocks renderblocks,
		...
		if (m == 0) {
			...
			tessellator.addVertexWithUV(i + 0.1875f, j + 0.75f, k + 0.125f,
					f3032, f1432);
			tessellator.addVertexWithUV(i + 0.1875f, j + 0.75f, k + 0.875f,
					f1832, f1432);
			tessellator.addVertexWithUV(i + 0.8125f, j + 0.75f, k + 0.875f,
					f1832, f432);
			tessellator.addVertexWithUV(i + 0.8125f, j + 0.75f, k + 0.125f,
					f3032, f432);
			// snout
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.5f, k, 1, f2732);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.5f, k + 1, 0.5f,
					f2732);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.1875f, k + 1, 0.5f,
					1);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.1875f, k, 1, 1);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.5f, k + 1, 0.5f,
					f2732);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.5f, k, 1, f2732);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.1875f, k, 1, 1);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.1875f, k + 1, 0.5f,
					1);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.5f, k + 1, f1132,
					0.25);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.5f, k + 1, f532,
					0.25);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.1875f, k + 1, f532,
					0.40625f);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.1875f, k + 1, f1132,
					0.40625f);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.5f, k + 0.875f,
					f2232, 0.5f); // f2232, 0.5f);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.5f, k + 0.875f,
					0.5f, 0.5f); // 0.5f, 0.5f);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.5f, k + 1, 0.5f,
					f1832); // , f1832);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.5f, k + 1, f2232,
					f1832); // f2232, f1832);
		} else if (m == 1) {
			...
			tessellator.addVertexWithUV(i + 0.125f, j + 0.75f, k + 0.1875f, 1,
					f2032);
			tessellator.addVertexWithUV(i + 0.125f, j + 0.75f, k + 0.8125f,
					f2232, f2032);
			tessellator.addVertexWithUV(i + 0.875f, j + 0.75f, k + 0.8125f,
					f2232, 1);
			tessellator.addVertexWithUV(i + 0.875f, j + 0.75f, k + 0.1875f, 1,
					1);
			// snout
			...
			tessellator.addVertexWithUV(i, j + 0.1875f, k + 0.3125f, f532,
					0.40625f);
			tessellator.addVertexWithUV(i, j + 0.1875f, k + 0.6875f, f1132,
					0.40625f);
			tessellator.addVertexWithUV(i, j + 0.5f, k + 0.6875f, f2232, 0.5f);
			tessellator.addVertexWithUV(i + 0.125f, j + 0.5f, k + 0.6875f,
					0.5f, 0.5f);
			tessellator.addVertexWithUV(i + 0.125f, j + 0.5f, k + 0.3125f,
					0.5f, f1832);
			...
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.1875f, k, f1132,
					0.40625f);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.1875f, k, f532,
					0.40625f);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.5f, k + 0.125f,
					0.5f, f1832); // 0.5f, 0.5f);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.5f, k + 0.125f,
					f2232, f1832); // f2232, 0.5f);
			tessellator.addVertexWithUV(i + 0.6875f, j + 0.5f, k, f2232, 0.5f); // f2232,
																				// f1832);
			tessellator.addVertexWithUV(i + 0.3125f, j + 0.5f, k, 0.5f, 0.5f); // ,
																				// f1832);
		} else {// if(m==3){
			...
			tessellator.addVertexWithUV(i + 0.875f, j + 0.75f, k + 0.1875f, 1,
					f2032);
			// snout
			tessellator.addVertexWithUV(i + 1, j + 0.5f, k + 0.6875f, 0.5f,
					f2732);
			tessellator.addVertexWithUV(i, j + 0.5f, k + 0.6875f, 1, f2732);
			tessellator.addVertexWithUV(i, j + 0.1875f, k + 0.6875f, 1, 1);
			tessellator.addVertexWithUV(i + 1, j + 0.1875f, k + 0.6875f, 0.5f,
					1);
			tessellator.addVertexWithUV(i, j + 0.5f, k + 0.3125f, 1, f2732);
			tessellator.addVertexWithUV(i + 1, j + 0.5f, k + 0.3125f, 0.5f,
					f2732);
			tessellator.addVertexWithUV(i + 1, j + 0.1875f, k + 0.3125f, 0.5f,
					1);
			tessellator.addVertexWithUV(i, j + 0.1875f, k + 0.3125f, 1, 1);
			tessellator.addVertexWithUV(i + 1, j + 0.5f, k + 0.3125f, f532,
					0.25);
			tessellator.addVertexWithUV(i + 1, j + 0.5f, k + 0.6875f, f1132,
					0.25);
			tessellator.addVertexWithUV(i + 1, j + 0.1875f, k + 0.6875f, f1132,
					0.40625f);
			tessellator.addVertexWithUV(i + 1, j + 0.1875f, k + 0.3125f, f532,
					0.40625f);
			tessellator.addVertexWithUV(i + 0.875f, j + 0.5f, k + 0.6875f,
					0.5f, 0.5f);
			tessellator.addVertexWithUV(i + 1, j + 0.5f, k + 0.6875f, f2232,
					0.5f);
			tessellator.addVertexWithUV(i + 1, j + 0.5f, k + 0.3125f, f2232,
					f1832);
			tessellator.addVertexWithUV(i + 0.875f, j + 0.5f, k + 0.3125f,
					0.5f, f1832);
		}
		return true;
	}
