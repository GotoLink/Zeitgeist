...
public class zei_EntityDoofFX extends EntityFX {
	float factor;
	float alp;

	public zei_EntityDoofFX(World world, double d, double d1, double d2,
	...
	public void renderParticle(Tessellator tessellator, float f, float f1,
		...
		Minecraft.getMinecraft().renderEngine.bindTexture(ClientProxy.FWOOSH);
		...
		float f14 = 1.0F;
		tessellator.setColorRGBA_F(particleRed * f14, particleGreen * f14,
				particleBlue * f14, alp);
